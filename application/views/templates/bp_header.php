    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a <?= $active[0]; ?> href="<?= site_url('backstage/orders') ?>"><i
                ...
                <li>
                    <a <?= $active[1]; ?> href="<?= site_url('backstage/users') ?>"><i class="fa fa-desktop fa-3x"></i>
                        用户</a>
                </li>
                <li>
                    <a <?= $active[2]; ?> href="<?= site_url('backstage/rooms') ?>"><i class="fa fa-qrcode fa-3x"></i>
                        房屋</a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="javascript:">成功交易</a>
                        </li>
                        <li>
                            <a href="javascript:">已认证</a>
                        </li>
                        <li>
                            <a href="javascript:">申请认证</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a <?= $active[3]; ?> href="<?= site_url('backstage/brands') ?>"><i
                                class="fa fa-bar-chart-o fa-3x"></i> 公告</a>
                </li>
                <li>
                    <a <?= $active[4]; ?> href="<?= site_url('backstage/areas') ?>"><i class="fa fa-table fa-3x"></i>
                        城市管理</a>
                </li>
                <!--                <li>-->
